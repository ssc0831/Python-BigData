...
import xlsxwriter
window = Tk()
photo = PhotoImage(file = 'C:/Users/admin/Desktop/Python, BigData/source/GIF/pic7.gif')
h = photo.height()
w = photo.width()
...
workbook = xlsxwriter.Workbook('C:/Users/admin/Desktop/Python, BigData/source/Excel/pic7.xlsx')
