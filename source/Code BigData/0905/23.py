...
window = Tk()
photo = PhotoImage(file = 'C:/Users/admin/Desktop/Python, BigData/source/GIF2/picture08.gif')
h = photo.height()
w = photo.width()
...
workbook = xlsxwriter.Workbook('C:/Users/admin/Desktop/Python, BigData/source/Excel/picture08_art.xlsx')
workSheetList = []
