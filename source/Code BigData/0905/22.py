...
import xlsxwriter
window = Tk()
photo = PhotoImage(file = 'C:/Users/admin/Desktop/Python, BigData/source/GIF2/picture06.gif')
h = photo.height()
w = photo.width()
...
workbook = xlsxwriter.Workbook('C:/Users/admin/Desktop/Python, BigData/source/Excel/picture06_art.xlsx')
