...
folderName = 'C:/Users/admin/Desktop/Python, BigData/source/yes24/'
wsName = 'IT 서적 순위'
...
while True :
    ...
    encoding = htmlObject.headers.get_content_charset()
    ...
    while True :
        try :
            ...
            webPage = htmlObject.read().decode(encoding, 'ignore')  # 웹페이지 인코딩 설정 사용
